...
async def addchannel(client, message):
    ...
    try:
        ...
        await message.reply_text(
            "<b>المساعد موجود بالفعل في المجموعة</b>",
        )
    except Exception as e:
        print(e)
        await message.reply_text(
            f"<b>🛑 حدث خطا ! 🛑 \n ان {user.first_name} لقد تم حظره ، قم برفع القيود عنه وارفعه مشرف"
            "\n\n او قم بأضفته بشكل يدوي </b>",
        )
        return
    await message.reply_text(
        "<b>المساعد موجود بالفعل في المجموعة</b>",
...
async def rem(USER, message):
    try:
        ...
        await message.reply_text(
            f"<b>المساعد لا يمنكه المغادره ، حاول مره ارخى !!"
            "\n\nOاو قم بطرده بشكل يدوي ،</b>",
        )
        return
