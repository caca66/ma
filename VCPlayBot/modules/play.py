...
def r_ply(type_):
    ...
    mar = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("⏹", "مغادره"),
                InlineKeyboardButton("⏸", "تشغيل"),
                InlineKeyboardButton("▶️", "ايقاف مؤقت"),
                InlineKeyboardButton("⏭", "الاغنيه التاليه"),
            ],
            [
                InlineKeyboardButton(" عرض قائمة الاغاني📖", "عرض قائمة الاغاني"),
            ],
    ...
    if type_ == "pause":
        ...
        marr = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("عرض قائمة الانتظار", "playlist"),
                ],
...
async def play(_, message: Message):
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"#⃣ الاغنيه في قائمة الانتظار <b>-</b> عدد الاغاني في الانتظار {position}!",
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ <b>قيد التشغيل ..</b> تم تشغيل الاغنيه بواسطة - {} ".format(
...
async def ytplay(_, message: Message):
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"#⃣ الاغنيه في قائمة الانتظار <b>-</b> عدد الاغاني في قائمة الانتظار - {position}!",
            reply_markup=keyboard,
        )
        os.remove("final.png")
        return await lel.delete()
...
async def lol_cb(b, cb):
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await b.send_photo(chat_id,
            photo="final.png",
            reply_markup=keyboard,
            caption=f"▶️ <b>قيد التشغيل ..</b> تم تشغيل الاغنيه بواسطة  {r_by.mention} ",
        )
        os.remove("final.png")
